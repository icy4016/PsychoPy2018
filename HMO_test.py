...
box1 =visual.Rect(myWin, pos=[-200,-200], width=20, height=20, lineWidth=3, lineColor=[1,0,0], fillColor=[1,0,0])
box2 =visual.Rect(myWin, pos=[0,-100], width=20, height=20, lineWidth=3, lineColor=[0,1,0], fillColor=None)
box3 =visual.Rect(myWin, pos=[200,0],width=20, height=20, lineWidth=3, lineColor=[0,0,1], fillColor=None)
dot =visual.Circle(myWin, radius=16, fillColor='black', lineColor=None)
